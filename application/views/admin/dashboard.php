    		...
    		<div class="col-md-12">
                ...
                <div class="box">
                    <div class="box-header width-border">
                        ...
                        <form method="POST" action="<?php echo base_url('dashboard/export')?>" - enctype="multipart/form-data" class="pull-right">
                    
                    <button  class="btn btn-primary" data-toggle="modal" ><i > EKSPORT DATA</i></i></button>
                </form>
    						...
    						<tbody>
                                ...
                                <tr>
    								...
    								<td>
    									...
    									<a href="<?= base_url('Dashboard/hapus/') ; ?><?= $dc->id ; ?>" class="btn btn-danger" onclick= "return confirm('yakin ingin menghapus Data'); " ><i class="glyphicon glyphicon-trash"></i></a>
    								</td>
    							</tr>
    							<?php } ?>
    						</tbody>
                ...
                <button class="btn btn-primary" data-toggle="modal" data-target="#modaltambah"><i class="fa fa-plus"> Tambah</i></i></button>
            ...
            <form action="<?= base_url('dashboard/tambah') ;?>" method="post">
               <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="pp" class="form-control" id="pp" placeholder="Pp"  required>
                </div>
                <div class="form-group">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="<?= base_url('Dashboard/update'); ?>" method="post">
                ...
                <div class="form-group">
                    <label for="pp">PP</label>
                    <input type="text" value="<?php echo $dc->pp ?>" name="pp" class="form-control" id="pp" placeholder="Kategori" value="<?= $dc->pp ;?>" required>
                </div>
                <div class="form-group">
                    <label for="odp">ODP</label>
